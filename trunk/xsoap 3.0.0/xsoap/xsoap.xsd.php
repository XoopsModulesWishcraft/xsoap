...
if ($_GET['funcname']!=''&&file_exists(XOOPS_ROOT_PATH.'/modules/xsoap/plugins/'.$_GET['funcname'].'.php')){
	...
	if (function_exists($funcxsd)){
		...
		echo '<schema targetNamespace="'.XOOPS_URL.'/modules/xsoap/wsdl/'.$func.'/schemas" xmlns="http://www.w3.org/2000/10/XMLSchema">'.chr(13);
