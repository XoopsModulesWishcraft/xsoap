...
if (!function_exists("adminMenu")) {
  function adminMenu ($currentoption = 0)  {
	  /* Nice buttons styles */
		...
		$xoopsModule = $module_handler->getByDirname('xsoap');
	   ...
	   if (file_exists(XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->getVar('dirname') . '/language/' . $xoopsConfig['language'] . '/modinfo.php')) {
		   include_once XOOPS_ROOT_PATH . '/modules/xsoap/language/' . $xoopsConfig['language'] . '/modinfo.php';
	   } else {
		   include_once XOOPS_ROOT_PATH . '/modules/xsoap/english/modinfo.php';
	   }
       
	   require_once XOOPS_ROOT_PATH . '/modules/xsoap/admin/menu.php';
	   global $adminmenu;
